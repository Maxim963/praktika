...
'''def log_request(req: 'flask_request', res: str) -> None:
    ...
    with UseDatabase(app.config['dbconfig']) as cursor:
        _SQL = """insert into log (phrase, letters, ip,
         browser_string, results) values (%s, %s, %s, %s, %s)"""
...
@app.route('/entry')
def entry_page() -> 'html':
    return render_template('entry.html', the_title='Привет! Найди общее во фразах c любым другим словом:')
